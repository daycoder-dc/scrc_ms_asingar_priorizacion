from fastapi import UploadFile, status, BackgroundTasks, Response
...
async def registra_pmu(file: UploadFile, session: Annotated[Session, Depends(database.get_session)]):
